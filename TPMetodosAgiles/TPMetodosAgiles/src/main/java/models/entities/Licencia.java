...
public class Licencia implements Serializable{
    ...
    private List<HistoricoLicencia> historicosLicencia;
    
    @OneToMany (mappedBy = "licencia")
    private List<RegistroTramite> registroTramites;
    ...
    public void add (HistoricoLicencia historicoLicencia){
        if (this.historicosLicencia == null){
            this.historicosLicencia = new ArrayList<>();
        }
        this.historicosLicencia.add(historicoLicencia);
    }
