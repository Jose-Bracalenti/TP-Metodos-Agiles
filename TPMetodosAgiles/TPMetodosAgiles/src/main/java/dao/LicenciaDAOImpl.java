...
public class LicenciaDAOImpl implements LicenciaDAO{
    ...
    public HistoricoLicencia mapHistoricoLicencia(LicenciaDTO licenciaDTO){
        HistoricoLicencia historicoLicencia = new HistoricoLicencia();
        historicoLicencia.setNroLicencia(licenciaDTO.getNumeroLicencia());
        historicoLicencia.setLicencia(null);
        historicoLicencia.setFechaInicioVigencia(licenciaDTO.getFechaInicioVigencia());
        historicoLicencia.setFechaFinVigencia(licenciaDTO.getFechaFinVigencia());
